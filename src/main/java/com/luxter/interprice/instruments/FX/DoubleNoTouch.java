...
public class DoubleNoTouch extends FX {
    ...
    public static class Builder extends FX.Builder<DoubleNoTouch, DoubleNoTouch.Builder> {
        ...
        public DoubleNoTouch build() {
            return new DoubleNoTouch( this );
        }
    ...
    private DoubleNoTouch( Builder builder ) {
        super( builder );
        ...
        this.baseInstrument = Service.InstrumentFxDoubleNoTouch.newBuilder()
    ...
    public String toString() {
        return String.format("\n\tDoubleNoTouch with:" +
                        ...
                        "\n\tBarrierLow:%f" +
                        "\n\tBarrierHigh:%f",
                underlying.get(), settlementDate.get(), expiryDate.get(), notional.get(), notionalCurrency.get(), barrierLow.get(), barrierHigh.get() );
    }
}
